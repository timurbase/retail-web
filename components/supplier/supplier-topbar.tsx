...
import { SupplierMobileSidebar } from "./supplier-mobile-sidebar";
  ...
  return (
    ...
    >
      ...
      <input
        ...
        placeholder="Do'kon, hujjat yoki mahsulot..."
...
export function SupplierTopbar({ breadcrumb }: SupplierTopbarProps) {
  return (
